...
function getCategory(user){
    ...
    let url = `./likedQuestionBack.php?sortBy=${sortBy.value}&category=${category.value}&user=${user}`;
    let xhr = new XMLHttpRequest();
    xhr.open("GET",url,true);
...
searchForm.firstElementChild.placeholder=`Search users liked question`;
...
searchForm.addEventListener("submit",(e)=>{
    ...
    let url = `./likedQuestionSearch.php?user=${user}&search=${input}`;
