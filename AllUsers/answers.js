...
function getCategory(user){
    ...
    let url = `./answerBack.php?sortBy=${sortBy.value}&category=${category.value}&user=${user}`;
    let xhr = new XMLHttpRequest();
...
searchForm.firstElementChild.placeholder=`Search users answers`;
...
searchForm.addEventListener("submit",(e)=>{
    ...
    // console.log(input);
    let url = `./answerSearch.php?user=${user}&search=${input}`;
    ...
    if(input != ""){
        ...
        xhr.onload = ()=>{
            ...
            let myAnsDiv = document.getElementById("myAns");
            myAnsDiv.innerHTML= data;
