        ...
        <div class='card my-5 bg-dark text-light'>
          ...
          <div class='card-body'>
            ...
            <div class= 'd-flex justify-content-between align-items-center'>
                <a href='../question/question.php?ques=$qSno&user=$sessionUsername' class='btn btn-secondary'>Open Question</a>
                <div class='d-flex flex-column align-items-center'> 
                  <i class='$likeClass fa-heart mx-3' onClick='likeFunc(this,$qSno,`$sessionUsername`)' ></i>
                  <small class='my-2'>$no_ofLikes</small>
                </div>
            </div>
          </div>
          <div class='ms-3'> 
            <button class='btn btn-danger me-2' onClick='delFunc($qSno,`$sessionUsername`)'> Delete </button>
