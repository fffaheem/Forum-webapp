...
function getCategory(){
    ...
    let url = `./likedAnswerBack.php?sortBy=${sortBy.value}&category=${category.value}`;
    let xhr = new XMLHttpRequest();
    xhr.open("GET",url,true);
...
searchForm.firstElementChild.placeholder="Search liked answers";
...
searchForm.addEventListener("submit",(e)=>{
    ...
    // console.log(input);
    let url = `./likedAnswerSearch.php?search=${input}`;
