...
function readMore(){
    let cardData = document.querySelectorAll(".quesCard .card-body .spaceRetain");
...
searchForm.firstElementChild.placeholder="Search all Questions";
