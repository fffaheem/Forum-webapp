function repliesDeleteFunc(e,sno){
    ...
    if(confirmed){
        ...
        let url = `./indexBack.php?del=true&replieSno=${sno}`;
...
function readMore(){
    let cardData = document.querySelectorAll(".replyCard .card-body .spaceRetain");
...
searchForm.firstElementChild.placeholder="Search all Replies";
